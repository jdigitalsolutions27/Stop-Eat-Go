...
export function Section({
  ...
  return (
    <motion.section
      ...
      className={cn("section-shell py-12 sm:py-16 lg:py-20", className)}
    >
      {(eyebrow || title || description) && (
        <div className="mb-8 max-w-3xl space-y-3 sm:mb-12">
          ...
          {description ? <p className="max-w-2xl text-base leading-7 text-[color:var(--muted)] sm:text-lg">{description}</p> : null}
        </div>
      )}
